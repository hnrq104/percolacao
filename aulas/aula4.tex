...
\[
	...
	i \leq n/\log n : S_i < \sqrt{n/\log n})]^{\log n} \leq
	\sqrt{\frac{\log n}{n}} + c^{\log n}.
\]
O bound segue daí. Para obter o resultado formalmente, podemos
multiplicamos os tamanhos dos intervalinhos
por alguma constante $c$, o mesmo para a altura do stopping time $R'$.
Depois de otimizar conseguimos
