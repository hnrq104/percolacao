...
\begin{proof}
	...
	\[
		...
		\land (x,y) \in (\Z^d)_p \quad \square \quad y \leftrightarrow \partial B_n).
	\]
...
todo $S$ a gente em média consegue escapar. Como era de se esperar,
...
\begin{proof}[Prova do teorema bonitão]
	...
	> \tilde{p}_c$,
	para todo tal $\cS_n$, temos $\phi_p(S) \geq 1$. Portanto,
	\[
...
$\Pr(x \leftrightarrow y) \geq (Cn)^{-d}$. Basta notar que (tomando $x = 0$)
\begin{align*}
	\Pr(0 \leftrightarrow y) \geq \frac{1}{|\partial B_n|} \Pr(0
	\leftrightarrow \partial B_n) \geq \frac{1}{p_c |\partial
